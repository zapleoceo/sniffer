...
CATEGORY_ATTRIBUTES: dict[Category, tuple[str, ...]] = {
    Category.MOTORBIKE: (
        "transmission", "engine_cc", "year_min", "brand",
        "condition", "papers", "delivery", "test_ride",
    ),
    Category.APARTMENT: (
        "rooms", "area_m2", "floor", "furnished", "air_conditioner",
        "washing_machine", "pool", "gym", "elevator", "balcony",
        "sea_view", "pets_allowed", "min_term_months", "deposit_months",
        "utilities_included",
    ),
    Category.ROOM: (
        "area_m2", "floor", "furnished", "air_conditioner", "shared",
