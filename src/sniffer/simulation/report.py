...
системное свойство поиска (чужой предмет отсекаем, чужое свойство только
опускаем баллом), красить им весь прогон бессмысленно. **Известный пробел** — то,
что ещё не сделано, с причиной: без этого блока красная строка и незаконченная
работа выглядят одинаково.
"""
