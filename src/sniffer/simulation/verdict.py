...
* **дефекты диалога** — лишний вопрос, потерянное поле, молчание, заглушка
  ...
  быть красным.
* **дефекты выдачи** — показанное противоречит запросу. Сегодня это системное
  свойство живого поиска, а не регресс: `rank_items` только упорядочивает и
  ничего не отсекает, поэтому чужая категория попадает в пятёрку по свежести.
  Красить этим весь прогон значило бы утопить сигнал о регрессе в постоянном
  красном.
"""
