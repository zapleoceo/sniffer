-- Стартовый набор очереди вступлений: 35 групп Нячанга из
-- docs/chats-nha-trang.md, снятых юзерботом через contacts.SearchRequest.
--
...
-- барахолка) 10..16, волна 2 (жильё) 20..28, волна 3 (общие чаты) 30..48.
-- Очередь разбирается по три чата в сутки, то есть полностью — за двенадцать
